    ...
    <>
      <div className="bg20 h-60">
        <div className="w-full glass py-2">
          ...
          <h1 className="text-md text-center lg:absolute lg:top-20 lg:inset-x-96 font-semibold text-gray-400">Made by <a className="text-cyan-500 cursor-pointer"> Shrey kumar</a></h1>
          <div className="flex flex-col items-center lg:absolute lg:top-24 lg:inset-x-96 justify-center space-y-2 py-2">
            <h1 className="text-center text-gray-400">
              Copyright &#169; 2022 <span className="text-cyan-500"><a href="/"> @Shreykumar </a></span> 42
            </h1>
