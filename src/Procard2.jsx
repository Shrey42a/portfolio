function Procard2(props){
    return (
        <>
         <div className="h-max w-4/5 flex lg:flex-row-reverse md:flex-row-reverse flex-col-reverse items-center justify-center glass ">
           ...
           <div className="z-0 hover:z-20 transition-all cursor-pointer hover:scale-110 hover:shadow ease-in-out flex items-center justify-center h-max md:h-max lg:h-max w-full md:w-2/5 lg:w-2/5 md:p-2 lg:p-2 lg:relative lg:left-24">
